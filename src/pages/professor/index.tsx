  ...
  return (
	...
	<div className="flex w-full max-w-screen-lg">
		<div className="flex flex-col w-64 py-4 pr-3">
			...
			className="px-3 py-2 mt-2 text-lg font-medium rounded-md hover:bg-gray-300" href="#">Испити из текућег рока</a>
			<a 
			                          onClick={() => {
										router.push("/professor/create");
									  }}
			className="px-3 py-2 mt-2 text-lg font-medium rounded-md hover:bg-gray-300" href="#">Креирај испит</a>
			<a 
			                  onClick={() => {
								router.push("/professor/subjects");
							  }}
			className="px-3 py-2 mt-2 text-lg font-medium rounded-md hover:bg-gray-300" href="#">Предмети</a>
			...
			<div className="flex-grow h-0 overflow-auto">
				<div className="flex w-full p-8 border-b-4 border-gray-300">
					...
					<div className="flex flex-col flex-grow ml-4">
						...
						className="p-3 bg-transparent border resize-none border-gray-500 rounded-md" name="" id=""  rows={3} placeholder="Унесите текст новог обавештења"></textarea>
						<div className="flex justify-between mt-2">
							<button 
							onClick={()=>{
								setImportant(!important)
							}}
							className="flex items-center h-8 px-3 text-xs rounded-md hover:bg-gray-200"> Важно</button>
							<button 
							onClick={async()=>{
								await createPost({
									input:{
							...
							className="flex items-center h-8 px-3 text-xs rounded-md bg-gray-300 hover:bg-gray-400">Објави</button>
						</div>
					</div>
				</div>
